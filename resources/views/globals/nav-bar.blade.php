<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar-header">
        <a href="index.html" class="header-logo">
            <div class="">
                <a href="https://www.intoxianime.com/2023/08/guia-de-temporada-outubro-2023/" target="_blank"><button class="btn btn-secondary btn-sm">Intoxy Anime</button></a>
                <a href="https://animesdigital.org/" target="_blank"><button class="btn btn-primary btn-sm">Anime Assistir</button></a>
            </div>
        </a>
    </div>
    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <li class="slide">
                    <a href="{{route('welcome')}}" class="side-menu__item">
                        <i class="ri-home-wifi-line side-menu__icon"></i>
                ...
                <li class="slide">
                    <a href="{{route('list_anime')}}" class="side-menu__item">
                        <i class="ri-file-list-line side-menu__icon"></i>
                        <span class="side-menu__label">Lista de Animes</span>
                    </a>
                </li>

                <!-- Menu::03::Skills -->
                <li class="slide__category"><span class="category-name">Habilidades</span></li>

                <li class="slide has-sub">
                    <a href="{{route('formAnime')}}" class="side-menu__item">
                        <i class="ri-body-scan-line side-menu__icon"></i>
                        <span class="side-menu__label">Cadastrar Anime</span>
                    </a>
